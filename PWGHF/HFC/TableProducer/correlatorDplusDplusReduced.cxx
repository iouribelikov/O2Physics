...
/// \brief Writer of D+ → π+ K- π+ pair candidates in the form of flat tables to be stored in TTrees.
    ...
    for (const auto& collision : collisions) {
      if (cfgSkimmedProcessing) {
        ...
        if (lastRunNumber != runNumber) {
          ...
          zorro.initCCDB(ccdb.service, runNumber, bc.timestamp(), "fHfDoubleCharm3P");
