...
/// \file DplusTablesReduced.h
/// \brief Definitions needed for D+D+ analysis.
///
/// \author inspired by Alexandre Bigot <alexandre.bigot@cern.ch>, IPHC Strasbourg

#ifndef PWGHF_HFC_DATAMODEL_DPLUSTABLESREDUCED_H_
#define PWGHF_HFC_DATAMODEL_DPLUSTABLESREDUCED_H_
...
DECLARE_SOA_INDEX_COLUMN(HfCandDpMcEv, hfCandDpMcEv);                              //! The MC collision index this MC particle belongs to
...
#endif // PWGHF_HFC_DATAMODEL_DPLUSTABLESREDUCED_H_
